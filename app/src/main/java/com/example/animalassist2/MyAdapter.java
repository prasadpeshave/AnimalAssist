...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        String fintext="Type of animal : " + ani + System.getProperty("line.separator") + "Location : " + locc +System.getProperty("line.separator")+ "Description: " + des +System.getProperty("line.separator")+ locc +System.getProperty("line.separator")+ "Urgency " + urge;
