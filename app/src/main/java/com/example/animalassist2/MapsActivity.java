...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.B_Vets:
                mMap.clear();
                String Vets = "Vets";
                String url = getUrl(latitude, longitude, Vets);
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
            ...
            case R.id.B_PET_SHOPS:
                mMap.clear();
                String pet_shops = "pet shops";
                url = getUrl(latitude, longitude, pet_shops);
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        Log.d("MapsActivity", "url = "+"AIzaSyDTWVLSHx-udICDlHhmnstJ9DhUe3Dwkr0");
